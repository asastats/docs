...
The website GitHub repository at https://github.com/asastats will be configured as publicly available and will ship with a permissive open source license. Afterward, it will be connected to Travis CI and all the pull requests for code changes would automatically run the test builds. Only the successful builds will qualify for a review and eventual code merging.
    ...
    a. Creating CI/CD pipeline for the documentation  
...
2. DEX implementation
   1. Creation of a dex package inside the main ASA Stats application
* 2-5 days
   * The development will start in parallel with Task 1 and Task 2.2 for AlgoDEX
   2. Creation of dex package modules for every DEX provider
...
4. AMM implementation
   1. Creation of amm package modules for every AMM provider
...
6. NFT markets/galleries implementation
   1. Creation of nft package inside the main ASA Stats application
* 2-5 days
   * The development will start in parallel with Task 5 and Task 6.2 for the four major NFT markets/galleries.
   2. Creation of nft package modules for each NFT market/gallery
...
7. Other dApps and engines research and implementation
   1. Folks Finance research and implementation
* 5-10 days
   * depends on Folks Finance’s cooperability, availability of documentation, and other factors
   2. Other providers research and implementation
* 2-15 days for each provider
   * depends on provider’s cooperability, availability of documentation, and other factors


8. Real-time data refresh
   1. Development and deployment of the background service communicating with the Algorand node 
* 5 days
   1. Development of the server-side modules responsible for communicating with the in-memory database and sending messages to the subscribers.
* 7 days
   1. Development of the client-side code used for rendering of the updated page elements.
* 7 days


9. Database system
   1. Database system provisioning
* 7 days
...
11. User settings system
   1. Settings database design and documentation
* 7 days
   1. User settings page
* 5 days
   1. Anonymous users settings
* 3 days
   1. Advanced users settings
* 7 days
...
13. Advanced bundles functionality
   1. Research of advanced bundles functionality
* 10 days
   1. Implementation of advanced bundles functionality
* 7 days


14. API call throttling
   1. API calls throttling research
* 7 days
   1. Implementation of API call throttling
* 5 days


15. Price and value events system
   1. Research of the types and specifics of the events
* 15 days
   1. Research of the optimal implementation for the events system
* 10 days
   1. Events database design and documentation
* 7 days
   1. Events system configuration
* 7 days
   1. Events system implementation
* 15 days


16. Widgets system
   1. Research of the comprehensible widget types
* 15 days
   1. Widget configuration system
* 7 days
   1. Development of the widget system - server-side
* 10 days
   1. Development of the widget system - client side
* 10 days


17. Website improvements
   1. Algofi staking of the Tinyman pool tokens
* 2 days
   1. Yieldly staking of the Tinyman pool tokens
* 2 days
   1. Optimal price and related amounts domain logic
* 5 days
   1. Integration and functional tests of the existing functionalities
* 20 days
   1. Client-side code unit tests (the existing functionalities)
* 7 days
   1. Filtering and searching by ASA
* 5 days
   1. ASA list pagination
* 2 days
   1. Mock portfolio builder
* 10 days
   1. Research and development of additional currencies
* 5 days
   1. Website’s internalization
* 5 days for the development
* 5-15 days for each major language to be added to the website


18. Subscription/payment system
   1. Research of possible solution providers
* 15 days
   1. Subscription tiers database setup
* 5 days
   1. Data from subscription tiers configured for providers
* 2-5 days
   * it depends of provider’s documentation and other factors
   2. Payment workflow implementation on the website
* 10 days
...
19. QA testing
   1. Beta testing administration
* 20 days
   1. Kubernetes cluster testing
* 5 days
   1. UX testing
...
* 15-30 days
   * it depends on the results of the discussion that started in the ASA Stats official channels
   2. Legal entity administration in the first two years
   3. Terms of use page
* 3 days
   1. Privacy policy page
* 3 days
   1. Legal documents for the professional users
* 7-10 days
   1. Contracts for the new members of the ASA Stats Team
* 7-10 days


22. Administration and support for the first two years        
   1. Load balancer and VPS purchase for the pre-Kubernetes phase
* 2 days
   1. Indexer instance purchase
   2. VPS purchase for the Kubernetes cluster
* 2 days
   * The period refers to the initial setup for all the VPS
   3. Customer support and feature requests
* 1 day
   1. Social media posts content writing
* ongoing efforts after the campaign starts


23. Containerization and Kubernetes cluster creation
   1. Containerization of the website services
* 15 days
   1. Adding Algorand infrastructure to the Kubernetes cluster
* 5 days
   1. Configuration files for the Kubernetes cluster deployment and services
* 20 days
...
25. Open-sourcing the website
   1. Creating CI/CD pipeline for the website
* 15 days
   1. Creating CI/CD pipeline for the documentation
* 10 days
